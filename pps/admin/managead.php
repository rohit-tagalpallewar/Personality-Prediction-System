<?php
	...
	{	?>
		...
		<form method='post'>
			...
			<div>
			<p><b>To update records of admin users please click on Update  button</b></p>
			...
			<hr>
			<div>
			<p><b>To delete records of the admin please click on Delete button</b></p>
