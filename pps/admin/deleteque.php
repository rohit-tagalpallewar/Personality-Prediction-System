<?php
	...
	{	?>
		...
		<form method='post'>
			...
			<div class='container'>
			<label for='qid'><b>question id(question to be deleted)</b></label>
			<input type='number' placeholder='enter valid id of question' name='qid' id='qid'>
			<hr>
		...
		<?php 
			...
			{
				$aid=$_POST['qid'];
				$sql="DELETE FROM questions where qid='$aid'";
