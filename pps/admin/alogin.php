...
<body>
<form method='post' action='alogin2.php'>
	...
	<div class='container'>
		<div class='window'>
			...
			<div class='input-fields'>
				<input type="text" placeholder="Username"  name='usr'  class='input-line full-width'>
				<input type="password" placeholder="Password" name='passw' class='input-line full-width'>


			</div>

			<div><button type='submit' name='login' class='ghost-round full-width'>login</button></div>
			</div>
		</div>
	</div>
